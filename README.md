...
![Release](https://img.shields.io/badge/Latest%20Release-v1.18.0-blue)
...
| ------------------------------------------------------ | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Gatekeeper Core](katalog/gatekeeper/core)             | `v3.23.1` | Gatekeeper deployment, ready to enforce rules.                                                                                                          |
...
| [Gatekeeper Policy Manager](katalog/gatekeeper/gpm)    | `v2.1.0`  | Gatekeeper Policy Manager, a simple to use web UI for Gatekeeper.                                                                                       |
| [Kyverno](katalog/kyverno)                             | `v1.19.1` | Kyverno is a policy engine designed for Kubernetes. It can validate, mutate and generate configurations using admission controls and background scans.  |
